...
/**
 * The order in which the different map layers are presented.
 */
...
/**
 * The map layer specifications hold any information needed to render them via the deck.gl framework.
 */
interface Layer {
  /**
...
export const LAYERS: Record<LayerKey, Layer> = {
  ...
  'Trips Layer': {
    ...
    timelineProps: {
      ...
      // startAnimationByDefault: false, // don't automatically start the animation on mobile devices
    },
